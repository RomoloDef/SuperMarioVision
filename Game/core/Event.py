...
class Event(object):
    ...
    def start_kill(self, core, game_over):
        ...
        # Settiamo l'immagine del player alla morte (l'ultima immagine della lista degli sprite)
    ...
    def start_win(self, core):
        ...
        # Aggiungiamo il punteggio bonus in base al tempo rimanente
