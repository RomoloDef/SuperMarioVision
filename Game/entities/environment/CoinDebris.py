...
class CoinDebris(object):
    ...
    Questa classe rappresenta i detriti di monete che appaiono quando Mario colpisce un blocco con una moneta sopra.
    I detriti di monete si muovono verso l'alto e poi cadono giù, e scompaiono quando tornano alla posizione originale.
